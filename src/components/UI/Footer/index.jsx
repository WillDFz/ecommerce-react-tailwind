...
const Footer = () => {
    return (
        <div className={`${styles.footer} grid grid-cols-12 px-3 py-5`}>
            <div className="md:container grid md:flex grid-cols-12 col-span-12 justify-between md:px-9">
                ...
                <div className="col-span-12 md:col-span-3 mb-3">
                    <h1 className="text-secondary font-bold mb-3">
                        Institucional
                    </h1>
                    <ul>
                        <li>
            ...
            <div className="col-span-12 mb-5 md:pl-8">
                <SocialLinks />
            </div>

            <div className="grid md:flex grid-cols-12 col-span-12 justify-between md:px-8">
